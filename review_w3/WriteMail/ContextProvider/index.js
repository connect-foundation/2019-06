...
export const WriteMailContextProvider = ({ children }) => {
  ...
  return (
    <WMstateContext.Provider value={state}>
      <WMdispatchContext.Provider value={dispatch}>
        {children}
      </WMdispatchContext.Provider>
...
export const useStateForWM = () => {
  ...
  if (ctx === undefined) {
    throw new Error(
      "useStateForWM은 WriteMailContextProvider 내에서 사용할 수 있습니다"
    );
  }
  return ctx;
};
...
export const useDispatchForWM = () => {
  ...
  if (ctx === undefined) {
    throw new Error(
      "useDispatchForWM은 WriteMailContextProvider 내에서 사용할 수 있습니다"
    );
  }
  return ctx;
};
